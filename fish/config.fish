...
if status is-interactive # Commands to run in interactive sessions can go here
    ...
    alias updatge 'sudo pacman -Syu && yay -Syu'
    alias yayge 'yay -S'
    alias pacge 'sudo pacman -S'
    alias please 'suge !!'
    alias hi 'echo "hello"'
    alias startWay 'waydroid session start'
    alias tower 'waydroid app launch com.TechTreeGames.TheTower'
    alias stopWay 'waydroid session stop'
    alias hypr 'start-hyprland'
    alias linux-class 'ssh nicduclos@10.172.12.225'
    alias connect '~/./ssh-manager.sh'
